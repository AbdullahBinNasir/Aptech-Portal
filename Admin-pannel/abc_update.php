					...
					<div class="pd-ltr-20 xs-pd-20-10">
						...
						<div class="min-height-200px">
                            ...
                            <div class="container my-4">
                                       <h1 class="text-center">Edit Event Details</h1>
                                   ...
                                   <input type="date" name="date" id="date" class="form-control my-2 red-input" placeholder="Enter event date" value="<?php echo $date ?>">
                                   ...
                                   <input type="date" name="deadline" id="deadline" class="form-control my-2 red-input" placeholder="Enter event deadline" value="<?php echo $deadline ?>">
