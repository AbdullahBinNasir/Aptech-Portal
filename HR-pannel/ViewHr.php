...
if (isset($_SESSION['username'])) {
	...
	if (mysqli_num_rows($get_Pic) > 0) {
		while ($data = mysqli_fetch_assoc($get_Pic)) {
			...
			$sql = "SELECT h.*, u.* FROM hr h INNER JOIN users u ON h.email = u.email;";
				...
				<div class="main-container">
					<div class="pd-ltr-20 xs-pd-20-10">
						...
						<div class="card-box mb-30">
							<div class="pd-20">
								<h4 class="text-danger h4">Human Resourse Data</h4>
													...
													<td>
														<div class="dropdown">
															...
															<div class="dropdown-menu dropdown-menu-right dropdown-menu-icon-list">
																<!-- <a class="dropdown-item" href="HrProfileEdit.php?id=<?php //echo $user['user_id']; ?>"><i class="dw dw-eye"></i>View</a> -->
																<!-- <a class="dropdown-item" href="#"><i class="dw dw-edit2"></i>Edit</a> -->
																<a class="dropdown-item" href="hr-remove.php?id=<?php echo $user['email']; ?>"><i class="dw dw-delete-3"></i>Delete</a>
															</div>
														</div>
													</td>
												</tr>
