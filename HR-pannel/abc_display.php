									...
									<div class="pb-20">
										...
										?>
												<table class="data-table table stripe hover nowrap">
												 ...
												 <a href='abc_update.php?id=" . $row['event_id'] . "' class='btn btn-warning px-4 rounded-pill m-1 '>Edit</a>
												 
                                                <a href='abc_delete.php?id=" . $row['event_id'] . "' class='btn btn-danger px-4 rounded-pill m-1' >Delete</a></td>
													</td>";
