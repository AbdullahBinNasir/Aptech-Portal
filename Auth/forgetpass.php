<?php 
include ("../Admin-pannel/Components/header.php");
...
function sendRecoveryLink($token, $email, $username){
    ...
    try {
        ...
        $mail->Password   = 'dxzw mkym xsnf zgmc';                               //SMTP password
        ...
        $mail->Body    = 'A request has been generated to reset your password. Please <b><a href="http://localhost:80/Aptech-Portal/Auth/resetpass.php?token='.$token.'&email='.$email.'">Click here</a></b> to reset your password.';
