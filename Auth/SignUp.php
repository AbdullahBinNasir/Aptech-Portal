        ...
        if (isset($_POST['signup']) && $_SERVER['REQUEST_METHOD'] == "POST") {
            if ($_FILES['image']['error'] == 4) {
                ...
                if ($size > 1000000) {
                    ...
                    $into = "INSERT INTO students(program, current_courses, CNIC, Father_Name, profile, email) VALUES ('$program','$courses','$CNIC','$father_Name','$newimgname','$email');";
...
<body class="login-page">
                ...
                <div class="col-md-6 col-lg-5">
                    <div class="register-box bg-white box-shadow border-radius-10">
                        <div class="wizard-content">
                            <form class="tab-wizard2 wizard-circle wizard" method="post" enctype="multipart/form-data" id="registrationForm">
                                ...
                                <section>
                                    <div class="form-wrap max-width-600 mx-auto">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-8">
                                                <input type="email" name="email" class="form-control" oninput="updateOverview()">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label class="col-sm-4 col-form-label">Username*</label>
                                            <div class="col-sm-8">
                                                <input type="text" name="username" class="form-control" oninput="updateOverview()">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label class="col-sm-4 col-form-label">Password*</label>
                                            <div class="col-sm-8">
                                                <input type="password" name="password" class="form-control" oninput="updateOverview()">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label class="col-sm-4 col-form-label">Father Name</label>
                                            <div class="col-sm-8">
                                                <input type="text" name="father-name" class="form-control" oninput="updateOverview()">
                                            </div>
                                        </div>
                                    </div>
                                </section>
                                ...
                                <section>
                                    <div class="form-wrap max-width-600 mx-auto">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-8">
                                                <input type="text" name="f-name" class="form-control" oninput="updateOverview()">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-8">
                                                <input type="text" name="address" class="form-control" oninput="updateOverview()">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label class="col-sm-4 col-form-label">Phone Number</label>
                                            <div class="col-sm-8">
                                                <input type="text" name="phone" class="form-control" oninput="updateOverview()">
                                            </div>
                                        </div>
                                    </div>
                                </section>
                                ...
                                <section>
                                    <div class="form-wrap max-width-600 mx-auto">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-8">
                                                <input type="text" name="CNIC" class="form-control" oninput="updateOverview()">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label class="col-sm-4 col-form-label">Program</label>
                                            <div class="col-sm-8">
                                                <select name="program" class="form-control" onchange="updateOverview()">
                                                    <option value="" disabled selected>Select Program</option>
                                                    <option value="Computer Science">ADSE</option>
                                                    <option value="Business Administration">CPISM
                                                    </option>
                                                    <option value="Electrical Engineering">DISM
                                                    </option>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-8">
                                                <select name="courses" class="form-control" onchange="updateOverview()">
                                                    <option value="">Select Course</option>
                                                    <?php
                                                    $getCrs = "SELECT * from courses;";
                                                    $getCrs_run = mysqli_query($connection, $getCrs) or die("failed to get categories");
                                                    if (mysqli_num_rows($getCrs_run) > 0) {
                                                        while ($crs = mysqli_fetch_assoc($getCrs_run)) {
                                                            echo '<option value="' . $crs['Course_id'] . '" >' . $crs['Course_Title'] . '</option>';
                                                        }
                                                    }
                                ...
                                <section>
                                    <div class="form-wrap max-width-600 mx-auto m-3">
                                        <ul class="list-group">
                                            <li class="list-group-item"><strong>Email Address:</strong> <span id="overviewEmail"></span></li>
                                            <li class="list-group-item"><strong>Username:</strong> <span id="overviewUsername"></span></li>
                                            <li class="list-group-item"><strong>Password:</strong> <span id="overviewPassword"></span></li>
                                            <li class="list-group-item"><strong>Father Name:</strong> <span id="overviewFatherName"></span></li>
                                            <li class="list-group-item"><strong>Full Name:</strong> <span id="overviewFullName"></span></li>
                                            <li class="list-group-item"><strong>Address:</strong> <span id="overviewAddress"></span></li>
                                            <li class="list-group-item"><strong>Phone Number:</strong> <span id="overviewPhoneNumber"></span></li>
                                            <li class="list-group-item"><strong>CNIC:</strong> <span id="overviewCNIC"></span></li>
                                            <li class="list-group-item"><strong>Program:</strong> <span id="overviewProgram"></span></li>
                                            <li class="list-group-item"><strong>Courses:</strong> <span id="overviewCourses"></span></li>
                                        </ul>
                                    </div>
                                </section>
                                <button id="success-modal-btn" hidden data-toggle="modal" name="signup" data-target="#success-modal" data-backdrop="static">Launch modal</button>
                            </form>
                        </div>
                    </div>
                </div>
    ...
    <script>
        function updateOverview() {
            ...
            document.getElementById("overviewProgram").innerText = document.querySelector("[name='program']").options[document.querySelector("[name='program']").selectedIndex].text;
            document.getElementById("overviewCourses").innerText = document.querySelector("[name='courses']").options[document.querySelector("[name='courses']").selectedIndex].text;
        }
