...
if (isset($_SESSION['username'])) {
    ...
    if (mysqli_num_rows($get_Pic) > 0) {
        while ($data = mysqli_fetch_assoc($get_Pic)) {
            ...
            // Fetch batches associated with the faculty
            $faculty_email = $_SESSION['email'];
            $sql = "SELECT b.* FROM batches b INNER JOIN faculty_batches fb ON b.batch_id = fb.batch_id WHERE fb.faculty_email = '$faculty_email'";
