				...
				<div class="main-container">
					<div class="pd-ltr-20 xs-pd-20-10">
						...
						<div class="card-box mb-30">
							<div class="pd-20">
								<h4 class="text-danger h4">All Faculty Data</h4>
								...
								<table class="data-table table stripe hover nowrap">
									...
									<tbody>
										...
										foreach ($users as $user) {
											if ($user['role'] == 'Employee' && $user['designation'] == 'Faculty') : ?>
													...
													<td>
														<div class="dropdown">
															...
															<div class="dropdown-menu dropdown-menu-right dropdown-menu-icon-list">
																<a class="dropdown-item" href="facultyProfileEdit.php?id=<?php echo $user['user_id']; ?>"><i class="dw dw-eye"></i>View</a>
																<!-- <a class="dropdown-item" href="#"><i class="dw dw-edit2"></i>Edit</a> -->
																<a class="dropdown-item" href="faculty-remove.php?id=<?php echo $user['employee_id']; ?>"><i class="dw dw-delete-3"></i>Delete</a>
															</div>
														</div>
													</td>
												</tr>
