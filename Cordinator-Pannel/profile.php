							...
							<div class="row">
								<div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 mb-30">
									<div class="pd-20 card-box height-100-p">
										...
										<p class="text-center text-muted font-14"><?php echo $data['designation']; ?></p>
																...
																<ul class="profile-edit-list row">
																	<li class="weight-500 col-md-9">
																		...
																		<div class="form-group">
																			...
																			<input class="form-control form-control-lg red-input" type="password" name="up_password" value="<?php echo $data['password'] ?>">
																		</div>
																		<div class="form-group">
																			<label>Role</label>
																		...
																		<div class="form-group">
																			...
																			<input class="form-control form-control-lg  red-input"  disabled type="text" value="<?php echo $data['hire_date'] ?>">
																		</div>
																		<div class="form-group">
																			<label>CNIC</label>
