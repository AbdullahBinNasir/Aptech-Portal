...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 16, 2024 at 01:15 AM
...
(11, 28, 88, 'Every Class', 'Yes', 'Excellent', 'Excellent', 'Yes', 'Every Class', 'Yes', 'Yes', '2024-08-15');
...
INSERT INTO `registrations` (`registration_id`, `event_id`, `student_id`, `registration_date`, `status`, `payment_details`) VALUES
(1, 2, 28, '2024-08-15', '', ''),
(2, 2, 28, '2024-08-15', NULL, NULL),
(3, 2, 28, '2024-08-16', NULL, NULL);
...
INSERT INTO `users` (`user_id`, `username`, `password`, `role`, `email`, `full_name`, `is_approved`, `address`, `phone_number`, `gender`, `token`) VALUES
...
(90, 'ItsMeMaady', '$2y$10$e54Kdk.zDRPjwHJ5VdyonOF1RXecp7tk20Y2Xtg/TclUqjIeX1yU2', 'Employee', 'syedammadali17@gmail.com', 'Syed Ammad Ali', 1, '2 F 7/5 Nazimabad, Karachi, Sindh', '3302388406', '', '07c11acea38ff1839a00b1d85655746a');
